...
class Sidebar:
    ...
    @staticmethod
    def about():
        about = st.sidebar.expander("🧠 About Perfect Pair ")
        sections = [
            "#### Perfect Pair is an AI chatbot with a conversational memory, designed to allow users to discuss their data in a more intuitive way. 📄",
    ...
    def show_options(self):
        with st.sidebar.expander("🛠️ Bottle Insight Setting", expanded=False):
