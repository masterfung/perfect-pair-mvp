...
from modules.bottle_insight.table_tool import PandasAgent
...
table_tool_module = reload_module('modules.bottle_insight.table_tool')
layout_module = reload_module('modules.layout')
utils_module = reload_module('modules.utils')
sidebar_module = reload_module('modules.sidebar')


st.set_page_config(layout="wide", page_icon="💬", page_title="Perfect Pair | List Insight 🤖")
